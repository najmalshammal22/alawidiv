        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="leavPPost.php" method="post" novalidate>
                    ...
                    <!--<div class="form-group mb-3">-->
                    <!--    <label for="validationCustom05">一个IP最多一天留言多少条内容</label>-->
                    <!--    <input type="text" class="form-control" id="validationCustom05" placeholder="请输入管理员QQ" name="111" value="" required>-->
                    <!--开发中-->
                    <!--</div>-->
